...
conn = sqlite3.connect(path.abspath(path.join('..', '..', '..', 'sample_files', 'db', 'week4_assignment_index.sqlite')))
cur = conn.cursor()
...
conn_1 = sqlite3.connect(path.abspath(path.join('..', '..', '..', 'sample_files', 'db', 'week4_assignment_mapping.sqlite')))
cur_1 = conn_1.cursor()
...
conn_1 = sqlite3.connect(path.abspath(path.join('..', '..', '..', 'sample_files', 'db', 'week4_assignment_content.sqlite')))
cur_1 = conn_1.cursor()
